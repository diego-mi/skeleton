 ...
 */
class Post extends \Post\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'content', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'type', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'authorId');
        }
